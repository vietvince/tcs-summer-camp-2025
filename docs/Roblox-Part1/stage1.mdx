...
<details>
    <summary>**Code Junior: Build Your First Staircase**</summary>

    <div className='image-wrapper'>
        ![stage1CodeJuniors](../../static/img/rblx1/stage1codejuniors.png)
    </div>
    ...
    **2.1 Gather Your Blocks**
    ...
    Start by collecting some basic blocks with your Code Coach's help. Get ready to begin your first building project!


    **2.2 Learn the Basics**

    Work with your Code Coach to understand how to place and adjust blocks. You'll learn how to move, rotate, and position them just right!

    **2.3 Assemble the Stairs**

    Now, put it all together! Arrange your blocks to form a simple staircase. Take it step by step, and soon you'll have your very own staircase ready for adventurers to climb!
