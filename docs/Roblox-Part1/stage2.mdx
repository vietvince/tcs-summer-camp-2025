...
import MyVideoUrl from './video/Stage2.mp4';
import ReactAudioPlayer from 'react-audio-player';
import audioFile from './video/gegagedigedagedago.mp3';
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage2Medium](./img/stage2Medium.png)
    </div>
...
<div align='center'>
    ![chickenNugget](./img/nugget-chicken.gif)
</div>
