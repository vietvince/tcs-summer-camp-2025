...
import audioFile from '../../static/audio/rblx1/giga-chad-theme.mp3';
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952980037?h=76a6aae274" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 1"></iframe>
    </div>
...
<div className='image-wrapper'>
    ![stage4Easy](../../static/img/rblx1/stage4Easy.png)
</div>
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage4Medium](../../static/img/rblx1/stage4Medium.png)
    </div>
...
<details>
    ...
    **If you want more of a challenge by recreating the video yourself, follow these steps:**
    ...
    __html: `
        <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
        <iframe src="https://player.vimeo.com/video/952505927?h=33ab8efa5a" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 4"></iframe>
        </div>
        <script src="https://player.vimeo.com/api/player.js"></script>
    `
    }} />
...
<div style={{
    ...
    ![robloxGigaChad](../../static/img/rblx1/roblox-giga-chad.gif)
</div>
