...
import audioFile from '../../static/audio/rblx1/monday-left-me-broken-cat.mp3';
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952980163?h=f2329d7c4f" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 1"></iframe>
    </div>
...
<div className='image-wrapper'>
    ![stage7Easy](../../static/img/rblx1/stage7Easy.png)
</div>
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage7Medium](../../static/img/rblx1/stage7Medium.png)
    </div>
...
<details>
    ...
    **If you want more of a challenge by recreating the video yourself, follow these steps:**
    ...
    __html: `
        <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
        <iframe src="https://player.vimeo.com/video/952505968?h=59dcc1b656" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 7"></iframe>
        </div>
        <script src="https://player.vimeo.com/api/player.js"></script>
    `
    }} />
...
<div align='center'>
    ![mondayLeftMeBroken](../../static/img/rblx1/cat-monday-left-me-broken-cat.gif)
</div>
