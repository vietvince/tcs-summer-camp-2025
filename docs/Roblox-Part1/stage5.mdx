...
import audioFile from '../../static/audio/rblx1/quandale-dingle.mp3';
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952980072?h=5c7e40b773" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 1"></iframe>
    </div>
...
Welcome to Stage 5: Fireball Footpath, where we'll set the skies ablaze with our coding prowess! Are you ready for some fireball fun? Let's dive in and ignite our creativity!

<div className='image-wrapper'>
    ![stage5Easy](../../static/img/rblx1/stage5Easy.png)
</div>

### 1.1 Crafting a Pathway

Let's start by creating a straight and simple pathway using your favorite Color and Material. Keep it smooth and steady like a river of lava!
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage5Medium](../../static/img/rblx1/stage5Medium.png)
    </div>
    ...
    **1.1 Create a Path**
    ...
    Craft a pathway with twists and turns that will ignite your coding creativity. Choose your Color and Material wisely!
    ...
    **1.2 Importing Parts**
    ...
    - Customize their colors and materials to suit your fiery vision.
</details>

## Step 2 - Setting Up the Checkpoint 🚩

But hold on, the adventure isn't over yet! Let's gear up for the next thrilling part of our journey.

### 2.1 Add Another SpawnLocation

Head to the Workspace and add a new SpawnLocation to mark your progress.

### 2.2 Customize Properties

Adjust these properties to match your fiery spirit:
- Pick a Color that reflects your passion for coding.
- Check AllowTeamChangeOnTouch to keep the flames burning.
- Uncheck Neutral to blaze your trail with confidence.
- Ensure the TeamColor matches the SpawnLocation's fiery hue.

### 2.3 Team Building

Add another Team to your Teams folder:
- Don't forget to uncheck AutoAssignable to make sure everything stays organized.
- Rename it to "Stage 6" to signify your fiery triumph.
...
<details>
    ...
    **If you want more of a challenge by recreating the video yourself, follow these steps:**
    ...
    __html: `
        <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
        <iframe src="https://player.vimeo.com/video/952505951?h=8dbc0e37a8" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 5"></iframe>
        </div>
        <script src="https://player.vimeo.com/api/player.js"></script>
    `
    }} />
...
<div style={{
    ...
    ![quandaleDingle](../../static/img/rblx1/quandale-dingle.jpg)
</div>
