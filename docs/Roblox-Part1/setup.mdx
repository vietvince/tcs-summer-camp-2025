...
import audioFile from '../../static/audio/rblx1/nerd-emoji-sound.mp3';
...
<div className="image-wrapper">
    ![baseplate](../../static/img/rblx1/baseplate.png)
</div>
...
<div className="image-wrapper">
    ![finishSetup](../../static/img/rblx1/finishSetup.png)
</div>
...
<div align="center">
    ![nerdEmoji](../../static/img/rblx1/nerd-emoji.gif)
</div>
