...
import audioFile from '../../static/audio/rblx1/happy-happy-happy-song.mp3';
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952980122?h=87abd118f7" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 1"></iframe>
    </div>
...
<div className='image-wrapper'>
    ![stage6Easy](../../static/img/rblx1/stage6Easy.png)
</div>
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage6Medium](../../static/img/rblx1/stage6Medium.png)
    </div>
...
<details>
    ...
    **If you want more of a challenge by recreating the video yourself, follow these steps:**
    ...
    __html: `
        <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
        <iframe src="https://player.vimeo.com/video/952505963?h=27154c9c7b" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 1 - Stage 6"></iframe>
        </div>
        <script src="https://player.vimeo.com/api/player.js"></script>
    `
    }} />
...
<div align='center'>
    ![happyCat](../../static/img/rblx1/happy-cat-happy-happy-cat.gif)
</div>
