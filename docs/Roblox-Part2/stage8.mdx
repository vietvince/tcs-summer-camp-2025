...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952506280?h=d013ce2e01" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 2 - Stage 8"></iframe>
    </div>
...
<div className='image-wrapper'>
    ![stage8Easy](../../static/img/rblx2/stage8Easy.png)
</div>
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage8Medium](../../static/img/rblx2/stage8Medium.png)
    </div>
