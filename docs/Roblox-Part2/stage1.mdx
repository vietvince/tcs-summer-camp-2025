...
import audioFile from '../../static/audio/rblx2/baller-roblox.mp3';
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952506228?h=ebb81861f1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 2 - Stage 1"></iframe>
    </div>
...
<div className='image-wrapper'>
    ![stage1Easy](../../static/img/rblx2/stage1Easy.png)
</div>
...
<details>
    ...
    <div className='image-wrapper'>
        ![stage1Medium](../../static/img/rblx2/stage1Medium.png)
    </div>
...
<div align='center'>
  ![baller](../../static/img/rblx2/baller-roblox.gif)
