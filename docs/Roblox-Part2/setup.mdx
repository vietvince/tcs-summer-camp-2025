...
import audioFile from '../../static/audio/rblx2/nerd-emoji-sound.mp3';
...
Hey there, future VR masters! Are you ready to kickstart our virtual reality adventure? Let's set up our workspace and get ready to unleash our creativity!
...
<div className='image-wrapper'>
    ![baseplate](../../static/img/rblx2/baseplate.png)
</div>

### 1.2 Get Ready to Build in VR
...
<div className='image-wrapper'>
    ![finishSetup](../../static/img/rblx2/finishSetup.png)
</div>
...
<div align='center'>
    ![nerdEmoji](../../static/img/rblx2/nerd-emoji.gif)
