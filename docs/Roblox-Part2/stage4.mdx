...
import audioFile from '../../static/audio/rblx2/giga-chad-theme.mp3';
...
<details style={{border:'none'}}>
    ...
    **1. Intro**
    ...
    You've embarked on this coding journey with eagerness and excitement. Now, get ready to take it up a notch in virtual reality!

    **2. Setup**

    You've laid the groundwork for your Obby adventure, ensuring everything is ready for your creative genius to shine in VR.

    **3. Stage 1: Ascending Walls**

    You've scaled heights and overcome obstacles, mastering the basics of obstacle creation. Now, let's push those boundaries even further in the virtual world!

    **4. Stage 2: Sphere Stairs**

    You've navigated through spheres and conquered stairs, showcasing your building skills. Get ready to elevate your game even more in VR!

    **5. Stage 3: Plank Walkway**

    You've walked the plank with finesse, creating a path of adventure. Now, let's gear up for the next challenge and keep the excitement going in the immersive VR environment!
...
<div dangerouslySetInnerHTML={{
  __html: `
    <div style="padding:56.25% 0 0 0;position:relative;border:3px solid #47c621;">
      <iframe src="https://player.vimeo.com/video/952506248?h=c45a9baaed" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Roblox Part 2 - Stage 4"></iframe>
    </div>
...
Welcome to the adrenaline-pumping fourth stage of our Obby! Get ready to unleash your creativity as we construct the thrilling KillBrick Path in virtual reality.

## Step 1 - Crafting the Path ⛏️👣

Hey there, VR adventurers! Stage 4 is here, and we're kicking it off with a teamwork challenge! Let's dive into virtual reality and work together to create a thrilling KillBrick Path. Remember, if you ever need a hand, your Code Coach is just a shout away!

<div className='image-wrapper'>
    ![stage4Easy](../../static/img/rblx2/stage4Easy.png)
</div>

### 1.1 Building a Straight Pathway

Let's start by building a straight pathway in VR:
- Using your favorite Color and Material.
- Keep it simple and steady for now, creating a smooth path in the virtual landscape!
...
- Search for "55hpmonk". 
- Import the "KillBrick" Part and place them strategically along your your VR path.
- Customize the color and material to make them stand out and look super cool in your virtual world!

<details>
    <summary>**Medium: Let your imagination run wild as you design your own killer path!**</summary>

    <div className='image-wrapper'>
        ![stage4Medium](../../static/img/rblx2/stage4Medium.png)
    </div>
    ...
    **1.1 Create a Pathway**
    ...
    Let your imagination run wild as you design a pathway full of twists and turns in VR! Use your favorite colors and materials to make it uniquely yours in the virtual landscape.
    ...
    **1.2 Import Kill bricks**
    ...
    - Customize the color and material to make them stand out and add a thrilling touch to your virtual world!
</details>

## Step 2 - Setting Up the Checkpoint 🚩

But wait, the adventure continues! Let's get ready for the next part of our journey in VR.

### 2.1 Add Another SpawnLocation

Navigate to the Workspace and bring in another SpawnLocation. This checkpoint is like a beacon of progress on your epic VR Obby journey!
...
**Congratulations! You've completed Stage 4 with flying colors! Now, gear up and get ready to conquer Stage 5 with even more excitement and determination! You're one step closer to Obby mastery in VR! 🌟**

<div align='center'>
    ![robloxGigaChad](../../static/img/rblx2/roblox-giga-chad.gif)
