...
## Turtle Shape 🟠 🟫
Open up your "My Turtle" Trinket and clear any code except for:
``` python
import turtle
...
<div className='image-wrapper2'>
    ![py1shapes](../../static/img/py1/py1shapes.gif)
</div>
<div align="center">
    <ReactAudioPlayer
        src={audioFile}
...
<div className='image-wrapper2'>
    ![py1speed](../../static/img/py1/py1speed.gif)
</div>
