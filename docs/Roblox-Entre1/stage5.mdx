...
import MyVideoUrl2 from './video/entre5medium.mp4'
import MyVideoUrl3 from './video/entre5hard.mp4'
import ReactAudioPlayer from 'react-audio-player';
import audioFile from './video/stage5meme.mp3';
...
<div style={{
    ...
    ![quandaleDingle](./img/stage5meme.jpg)
</div>
