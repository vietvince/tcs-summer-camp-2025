...
import audioFile from '../../static/audio/entre1/setupmeme.mp3';
...
<div className="image-wrapper">
    ![baseplate](../../static/img/entre1/baseplate.png)
</div>
...
<div className="image-wrapper">
    ![finishSetup](../../static/img/entre1/finishSetup.png)
</div>
...
<div align="center">
    ![nerdEmoji](../../static/img/entre1/setupmeme.gif)
</div>
