...
import MyVideoUrl2 from './video/entre2medium.mp4'
import MyVideoUrl3 from './video/entre2hard.mp4'
import ReactAudioPlayer from 'react-audio-player';
import audioFile from './video/stage2meme.mp3';
...
<div align='center'>
    ![chickenNugget](./img/stage2meme.gif)
</div>
