...
<details>
    <summary><strong>Hard: Add sound effect to plant</strong></summary>

**Goal: Add sound effects when a plant is performing an action.**

    **4.1 Add sound to the plant object**

        As expert Unity developers, we must add some sounds to our plants.

    **4.2 Add sound events**

        Make sounds play when a certain event happens, like when you place a plant.
</details>